...
const sd_bus_vtable bus_exec_vtable[] = {
        ...
        SD_BUS_PROPERTY("MemoryDisableTHPExceptMadvise", "b", bus_property_get_tristate, offsetof(ExecContext, memory_disable_thp_except_madv), SD_BUS_VTABLE_PROPERTY_CONST),
...
int bus_exec_context_set_transient_property(
        ...
        if (streq(name, "MemoryDisableTHPExceptMadvise"))
                return bus_set_transient_tristate(u, name, &c->memory_disable_thp_except_madv, message, flags, error);
